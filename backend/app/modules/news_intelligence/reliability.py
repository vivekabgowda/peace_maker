...
_REGISTRY: tuple[SourceProfile, ...] = (
    ...
    SourceProfile("nse", "NSE Corporate Announcements", SourceTier.TIER_1, 100,
                  ("nse", "national stock exchange", "nseindia")),
    SourceProfile("bse", "BSE Corporate Announcements", SourceTier.TIER_1, 100,
    ...
    SourceProfile("company_filing", "Company Filing", SourceTier.TIER_1, 98,
                  ("filing", "regulatory filing", "exchange filing", "disclosure")),
    SourceProfile("results", "Quarterly Results / Annual Report", SourceTier.TIER_1, 98,
                  ("quarterly result", "annual report", "results filing", "financial result")),
    SourceProfile("investor_presentation", "Investor Presentation", SourceTier.TIER_1, 95,
                  ("investor presentation", "investor deck", "earnings call")),
    SourceProfile("corporate_action", "Corporate Action", SourceTier.TIER_1, 96,
                  ("corporate action", "record date", "ex-date")),
    # --- Tier 2 (press releases, major financial press, govt) ---
    SourceProfile("press_release", "Company Press Release", SourceTier.TIER_2, 88,
                  ("press release", "company statement", "official statement")),
    SourceProfile("govt", "Government Notification", SourceTier.TIER_2, 90,
                  ("ministry", "government of india", "gazette", "pib", "notification")),
    SourceProfile("et", "Economic Times", SourceTier.TIER_2, 90,
    ...
    SourceProfile("bql", "Bloomberg / Reuters", SourceTier.TIER_2, 90,
                  ("bloomberg", "reuters", "bqprime", "bq prime")),
    # --- Tier 3 (global macro / secondary) ---
    SourceProfile("global_macro", "Global Macro Wire", SourceTier.TIER_3, 75,
    ...
    SourceProfile("blog", "Financial Blog", SourceTier.UNTRUSTED, 60,
                  ("blog", "blogspot", "wordpress", "medium.com", "substack")),
    SourceProfile("social", "Social Media", SourceTier.UNTRUSTED, 0,
