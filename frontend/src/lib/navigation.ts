...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Recommendations', href: '/recommendations', icon: 'M12 3l2.5 5 5.5.8-4 3.9 1 5.5L12 16l-5 2.6 1-5.5-4-3.9 5.5-.8z' },
  ...
  { label: 'Settings', href: '/settings', icon: 'M12 8a4 4 0 100 8 4 4 0 000-8zM3 12h2m14 0h2M12 3v2m0 14v2' },
  { label: 'Admin', href: '/admin', icon: 'M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7z', adminOnly: true },
];
